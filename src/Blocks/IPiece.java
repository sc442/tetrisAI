...
public class IPiece extends Block {
    ...
    public void updateSquares() {
        ...
        switch(state){
            case 0:
                sq1 = new Pair<>(cr+1,cc);
                sq2 = new Pair<>(cr+1,cc+1);
                sq3 = new Pair<>(cr+1,cc+2);
                sq4 = new Pair<>(cr+1,cc+3);
                squares = new ArrayList<>(Arrays.asList(sq1,sq2,sq3,sq4));
                break;
            case 1:
                sq1 = new Pair<>(cr,cc+2);
                sq2 = new Pair<>(cr+1,cc+2);
                sq3 = new Pair<>(cr+2,cc+2);
                sq4 = new Pair<>(cr+3,cc+2);
                squares = new ArrayList<>(Arrays.asList(sq1,sq2,sq3,sq4));
                break;
            case 2:
                sq1 = new Pair<>(cr+2,cc);
                sq2 = new Pair<>(cr+2,cc+1);
                sq3 = new Pair<>(cr+2,cc+2);
                sq4 = new Pair<>(cr+2,cc+3);
                squares = new ArrayList<>(Arrays.asList(sq1,sq2,sq3,sq4));
                break;
            case 3:
